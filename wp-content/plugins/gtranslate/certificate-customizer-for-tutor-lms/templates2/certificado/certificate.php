...
<head>
    ...
    <title>Titlo do Certificado  PDF</title>
...
<div class="certificate-wrap">
    ...
    <div class="certificate-content">
		...
		?>
        <h1 class="nome_aluno"> <?php echo $user->display_name; ?></h1>
        <div class="descricao_texto">

        <p>  Completou com Sucesso <?php echo $duration_text; ?> o </p>
        <h2 class="titulo_curso"> <?php echo $course->post_title; ?> </h2>
        <p> no dia  <?php echo date('F d, Y', strtotime( $completed->completion_date) ); ?></p>
    ...
    <div class="certificate-footer">
        ...
        <table>
            ...
            <tr>
                <td class="first-col">
                    <p class="id_certificado"> <strong>ID do Certificado  Válido</strong> </p>
                </td>
                <td>
