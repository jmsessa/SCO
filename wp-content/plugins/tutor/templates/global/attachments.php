                    ...
                    <div class="tutor-card-body">
                        <div class="tutor-row">
                            <div class="tutor-col tutor-overflow-hidden">
                                ...
                                <div class="tutor-fs-7 tutor-color-muted"><?php _e('Tamanho', 'tutor'); ?>: <?php echo esc_html( $attachment->size ); ?></div>
                            </div>
...
<?php else :
    tutor_utils()->tutor_empty_state(__('Nenhum anexo encontrado', 'tutor'));
endif;
