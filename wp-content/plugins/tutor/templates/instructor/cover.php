...
<div class="tutor-instructor-list-item tutor-instructor-layout-cover tutor-card">
    <div class="tutor-instructor-cover tutor-ratio tutor-ratio-16x9">
        <img class="tutor-instructor-cover-photo" src="<?php echo esc_url( tutor_utils()->get_cover_photo_url( $instructor->ID ) ); ?>" alt="<?php _e("Foto da capa do instrutor", "tutor"); ?>" loading="lazy">
    </div>
    ...
    <div class="tutor-card-body">
        ...
        <div class="tutor-instructor-courses">
            ...
            <span class="tutor-color-muted"><?php $instructor->course_count > 1 ? esc_html_e( 'Cursos', 'tutor' ) : esc_html_e( 'Cursos', 'tutor' ); ?></span>
        </div>

        <a href="<?php echo esc_url( tutor_utils()->profile_url( $instructor->ID, true ) ); ?>" class="tutor-stretched-link">
            <span class="tutor-d-none"><?php _e( "Detalhes", "tutor" ); ?></span>
        </a>
    </div>
</div>
