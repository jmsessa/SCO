...
<div class="tutor-course-topic-single-body">
	...
	<div class="tutor-course-spotlight-wrapper">
		<ul class="tutor-nav tutor-course-spotlight-nav tutor-justify-center">
			...
			<li class="tutor-nav-item">
				<a href="#" class="tutor-nav-link<?php echo 'Arquivos' == $page_tab ? ' is-active' : ''; ?>" data-tutor-nav-target="tutor-course-spotlight-files" data-tutor-query-variable="page_tab" data-tutor-query-value="files">
					<span class="tutor-icon-paperclip tutor-mr-8" area-hidden="true"></span>
					<span><?php _e( 'Arquivos de exercícios', 'tutor' ); ?></span>
				</a>
			</li>

			<?php if ( $is_comment_enabled ) : ?>
			<li class="tutor-nav-item">
				<a href="#" class="tutor-nav-link<?php echo 'Comentarios' == $page_tab ? ' is-active' : ''; ?>" data-tutor-nav-target="tutor-course-spotlight-comments" data-tutor-query-variable="page_tab" data-tutor-query-value="comments">
					<span class="tutor-icon-comment tutor-mr-8" area-hidden="true"></span>
					<span><?php _e( 'Comentarios', 'tutor' ); ?></span>
				</a>
			</li>
			<?php endif; ?>
		</ul>
		...
		<div class="tutor-tab tutor-course-spotlight-tab">
			...
			<div id="tutor-course-spotlight-files" class="tutor-tab-item<?php echo 'Arquivos' == $page_tab ? ' is-active' : ''; ?>">
				<div class="tutor-container">
					<div class="tutor-row tutor-justify-center">
						<div class="tutor-col-xl-8">
							<div class="tutor-fs-5 tutor-fw-medium tutor-color-black"><?php _e( 'Arquivos de Exercicios', 'tutor' ); ?></div>
			...
			<?php if ( $is_comment_enabled ) : ?>
			<div id="tutor-course-spotlight-comments" class="tutor-tab-item<?php echo 'Comentários' == $page_tab ? ' is-active' : ''; ?>">
				<div class="tutor-container">
