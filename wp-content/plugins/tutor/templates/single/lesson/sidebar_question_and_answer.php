...
if(!count($questions)) : ?>
	<div class="tutor-empty-state-wrapper">
        <div class="tutor-empty-state td-empty-state tutor-p-32 tutor-text-center">
			<img src="<?php echo esc_url( tutor()->url . 'assets/images/empty-qa.svg' ); ?>" alt="<?php __( "Nenhum dado disponível nesta seção", "tutor" ); ?>" width="85%">
			<div class="tutor-fs-6 tutor-color-secondary tutor-text-center tutor-mt-20">
				<?php _e( "Sem Questões", "tutor" ); ?>
			</div>
			<div class="tutor-fs-7 tutor-color-muted tutor-mt-12">
				<?php _e( "Descreva o que você está tentando alcançar e onde está travando", "tutor" ); ?>
			</div>
		</div>
	</div>
<?php endif;
