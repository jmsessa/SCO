    ...
    <?php
        ...
        <div class="tutor-image-answer">
            ...
            <div class="quiz-question-ans-choice">
                <input type="text" class="tutor-form-control" placeholder="<?php _e('Escreva sua resposta aqui', 'tutor'); ?>" name="attempt[<?php echo $is_started_quiz->attempt_id; ?>][quiz_question][<?php echo $question->question_id; ?>][answer_id][<?php echo $answer->answer_id; ?>]" />
            </div>
        </div>
    <?php } } ?>
</div>