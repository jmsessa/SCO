		...
		<div class="tutor-quiz-info-area tutor-mb-60 tutor-mt-24">
			...
			?>
				<div class="tutor-quiz-info">
					<span class="tutor-fs-6 tutor-color-muted"><?php _e('Questões', 'tutor'); ?>:</span>
			...
			?>
				<div class="tutor-quiz-info">
					<span class="tutor-fs-6 tutor-color-muted"><?php _e('Hora das perguntas', 'tutor'); ?>:</span>
					<span class="tutor-fs-6 tutor-color-black">
			...
			<div class="tutor-quiz-info">
				<span class="tutor-fs-6 tutor-color-muted">
					<?php _e('Total de Tentativas', 'tutor'); ?>:
				</span>
				<span class="tutor-fs-6 tutor-color-black">
			...
			<?php if( $passing_grade ) : ?>
				<div class="tutor-quiz-info">
					<span class="tutor-fs-6 tutor-color-muted"><?php _e( 'Nota de Aprovação', 'tutor' ); ?></span>
		...
		?>
			...
			<?php
				tutor_load_template( 'modal.confirm', array(
					...
					'title' => __('Você quer pular este questionário?', 'tutor'),
					'content' => __('Tem certeza de que deseja pular este teste? Por favor, confirme sua escolha.', 'tutor'),
					'yes' => array(
						'text' => __('Sim, pule isso', 'tutor'),
