...
<div class="tutor-row">
	<div class="tutor-col-12 tutor-col-md-6">
		...
		<select class="tutor-form-select tutor-form-control tutor-form-control-sm tutor-announcement-course-sorting">
			...
			<?php if ( $courses ) : ?>
				...
				<?php endforeach; ?>
			<?php else : ?>
				<option value=""><?php esc_html_e( 'Curso não encontrado', 'tutor' ); ?></option>
			<?php endif; ?>
		</select>
	</div>
	<div class="tutor-col-xs-6 tutor-col-md-3 tutor-mt-lg-0">
		<label class="tutor-form-label tutor-d-block tutor-mb-10"><?php esc_html_e( 'Ordenar por', 'tutor' ); ?></label>
	...
	<div class="tutor-col-xs-6 tutor-col-md-3 tutor-mt-lg-0">
		<label class="tutor-form-label tutor-d-block tutor-mb-10"><?php esc_html_e( 'Data de Criação', 'tutor' ); ?></label>
