		...
		<div class="tutor-table-responsive">
			<table class="tutor-table table-reviews">
				<thead>
					<tr>
						<th width="20%">
							<?php esc_html_e( 'Estudante', 'tutor' ); ?>
						</th>
						<th width="25%">
							<?php esc_html_e( 'Data', 'tutor' ); ?>
						</th>
						<th>
							<?php esc_html_e( 'Opinião', 'tutor' ); ?>
						</th>
					</tr>
				</thead>
