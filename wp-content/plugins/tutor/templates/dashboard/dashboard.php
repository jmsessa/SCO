				...
				<div class="tutor-row tutor-gx-0">
					<div class="tutor-col-lg-7 <?php echo tutor_utils()->is_instructor() ? 'tutor-profile-completion-content-admin' : ''; ?>">
						<div class="tutor-fs-5 tutor-fw-medium tutor-color-black">
							<?php esc_html_e( 'Complete o seu perfil', 'tutor' ); ?>
						</div>
						...
						<div class="tutor-fs-6 tutor-mt-20">
							<?php
								$profile_complete_text = __("Por favor, complete o perfil", "tutor");
								if($complete_count > ( $total_count / 2 ) && $complete_count < $total_count) {
									$profile_complete_text = __("Você está quase pronto", "tutor");
								} else if($complete_count === $total_count) {
									$profile_complete_text = __("Obrigado por completar seu perfil", "tutor");
								}
			...
			$alert_message = sprintf(
				'<div class="tutor-alert tutor-primary tutor-mb-20">
					...
					<div class="alert-btn-group">
						<a href="%s" class="tutor-btn tutor-btn-sm">'.__('Clique aqui', 'tutor').'</a>
					</div>
				</div>',
...
<div class="tutor-dashboard-content-inner">
	...
	$status_translations = array(
		'publish' => __( 'Publicado', 'tutor' ),
		'pending' => __( 'Pendente', 'tutor' ),
		'trash'   => __( 'Lixo', 'tutor' ),
	);
		...
		<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
			<div class="tutor-card">
				<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
					...
					<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Cursos Matriculados', 'tutor' ); ?></div>
		...
		<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
			<div class="tutor-card">
				<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
					...
					<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Cursos ativos', 'tutor' ); ?></div>
		...
		<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
			<div class="tutor-card">
				<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
					...
					<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Cursos Concluídos', 'tutor' ); ?></div>
			...
			<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
				<div class="tutor-card">
					<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Total de Estudantes', 'tutor' ); ?></div>
			...
			<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
				<div class="tutor-card">
					<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Totais de cursos', 'tutor' ); ?></div>
			...
			<div class="tutor-col-lg-6 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-32">
				<div class="tutor-card">
					<div class="tutor-d-flex tutor-flex-lg-column tutor-align-center tutor-text-lg-center tutor-px-12 tutor-px-lg-24 tutor-py-8 tutor-py-lg-32">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Ganhos totais', 'tutor' ); ?></div>
...
<?php if ( $courses_in_progress && $courses_in_progress->have_posts() ) : ?>
	<div class="tutor-frontend-dashboard-course-progress">
		<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-capitalize-text tutor-mb-24">
			<?php esc_html_e( 'Cursos em andamento', 'tutor' ); ?>
		</div>
		<?php 
					...
					<div class="tutor-col-lg-8 tutor-align-self-center">
						<div class="tutor-card-body">
							...
							<div class="tutor-d-flex tutor-fs-7 tutor-mb-32">
								<span class="tutor-color-muted tutor-mr-4"><?php esc_html_e( 'Lições concluídas:', 'tutor' ); ?></span>
								<span class="tutor-fw-medium tutor-color-black">
									<span>
										<?php echo esc_html( $course_progress['completed_count'] ); ?>
									</span>
									<?php esc_html_e( 'de', 'tutor' ); ?>
									<span>
										<?php echo esc_html( $course_progress['total_count'] ); ?>
									</span>
									<?php echo esc_html( _n( 'Lição', 'lessons', $completed_number, 'tutor' ) ); ?>
								</span>
							</div>
							...
							<div class="tutor-row tutor-align-center">
								...
								<div class="tutor-col-auto">
									<span class="progress-percentage tutor-fs-7 tutor-color-muted">
										...
										</span><?php esc_html_e( 'Completo', 'tutor' ); ?>
									</span>
								</div>
							</div>
						</div>
...
if ( count( $instructor_course ) ) {
	...
	?>
		<div class="popular-courses-heading-dashboard tutor-d-flex tutor-justify-between tutor-mb-24 tutor-mt-md-40 tutor-mt-0">
			<span class="tutor-fs-5 tutor-fw-medium tutor-color-black"><?php esc_html_e( 'Meus Cursos', 'tutor' ); ?></span>
			<a class="tutor-btn tutor-btn-ghost" href="<?php echo esc_url( tutor_utils()->tutor_dashboard_url( 'my-courses' ) ); ?>">
				<?php esc_html_e( 'Ver tudo', 'tutor' ); ?>
			</a>
		</div>
				...
				<table class="tutor-table table-popular-courses">
					<thead>
						<tr>
							...
							<th>
								<?php esc_html_e( 'Matriculado', 'tutor' ); ?>
							</th>
							<th>
								<?php esc_html_e( 'Avaliação', 'tutor' ); ?>
							</th>
						</tr>
					</thead>
