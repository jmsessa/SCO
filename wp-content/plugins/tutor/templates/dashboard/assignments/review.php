...
if ( ! $assignment_submitted_id ) {
	esc_html_e( "Desculpe, mas você está procurando por algo que não está aqui.", 'tutor' );
	return;
}
?>
...
<div class="tutor-dashboard-content-inner tutor-dashboard-assignment-review">
	...
	<div class="tutor-assignment-review-header">
		<div class="tutor-row tutor-align-center tutor-mb-16">
			<div class="tutor-col-lg-3">
				<span class="tutor-color-secondary"><?php esc_html_e( 'Curso', 'tutor' ); ?>:</span>
			</div>
		...
		<div class="tutor-row tutor-align-center tutor-mb-16">
			<div class="tutor-col-lg-3">
				<span class="tutor-color-secondary"><?php esc_html_e( 'Estudante', 'tutor' ); ?>:</span>
			</div>
			<div class="tutor-col-lg tutor-mt-8 tutor-mt-lg-0">
	...
	<div class="tutor-dashboard-assignment-submitted-content tutor-mt-32 tutor-mb-16">
		<h5 class="tutor-fs-6 tutor-fw-medium tutor-mb-5">
			<?php esc_html_e( 'Descrição da Atribuição:', 'tutor' ); ?>
		</h5>
		...
		if ( $attached_files && is_array( json_decode( $attached_files ) ) ) :
			...
			<div class="tutor-fs-5 tutor-fw-medium tutor-mb-20">
				<?php _e( 'Anexar arquivo(s) de atribuição', 'tutor' ); ?>
			</div>
									...
									<div class="tutor-col-lg-6 tutor-mb-16 tutor-mb-lg-0">
										<div class="tutor-card tutor-d-flex tutor-align-center tutor-px-16 tutor-py-12">
											<div>
												...
												<div class="tutor-fs-7 tutor-color-muted"><?php esc_html_e( 'tamanho', 'tutor' ); ?><?php esc_html_e( ': 2MB', 'tutor' ); ?></div>
											</div>
	...
	<div class="tutor-dashboard-assignment-review-area tutor-mt-32">
		<h3><?php esc_html_e( 'Avaliação', 'tutor' ); ?></h3>
		<form action="" method="post" class="tutor-row tutor-form-submit-through-ajax" data-toast_success_message="<?php _e( 'Tarefa avaliada', 'tutor' ); ?>">
			...
			<div class="tutor-col-12 tutor-col-sm-4 tutor-col-md-12 tutor-col-lg-3">
				<label for=""><?php esc_html_e( 'Seus pontos', 'tutor' ); ?></label>
			</div>
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-9 tutor-mb-32">
				<input type="number"  class="tutor-form-control" name="evaluate_assignment[assignment_mark]" value="<?php echo $given_mark ? $given_mark : 0; ?>" min="0" max="<?php echo esc_attr( $max_mark ); ?>" title="<?php esc_attr_e( 'A nota de avaliação não pode ser maior que a nota total', 'tutor' )?>">
				<p class="desc"><?php echo sprintf( __( 'Avalie esta tarefa de %s', 'tutor' ), "<code>{$max_mark}</code>" ); ?></p>
			</div>

			<div class="tutor-col-12 tutor-col-sm-4 tutor-col-md-12 tutor-col-lg-3">
				<label for=""><?php esc_html_e( 'Opinião', 'tutor' ); ?></label>
			</div>
			...
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-9">
				<button type="submit" class="tutor-btn tutor-btn-primary tutor-mt-16">
					<?php esc_html_e( 'Avalie este envio', 'tutor' ); ?>
				</button>
			</div>
		</form>
	</div>
