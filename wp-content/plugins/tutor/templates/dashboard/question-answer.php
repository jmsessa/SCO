    ...
    <div class="tutor-row tutor-mb-24">
        <div class="tutor-col">
            <div class="tutor-fs-5 tutor-fw-medium tutor-color-black">
                <?php _e('Perguntas e Respostas', 'tutor'); ?>
            </div>
        </div>
        ...
        <?php if ($is_instructor) : ?>
            <div class="tutor-col-auto">
                <label class="tutor-form-toggle tutor-dashboard-qna-vew-as tutor-d-flex tutor-justify-end current-view-<?php echo $view_as == 'instructor' ? 'instructor' : 'student'; ?>">
                    ...
                    <span class="tutor-form-toggle-label tutor-form-toggle-<?php echo $view_as == 'student' ? 'checked' : 'unchecked'; ?>"><?php _e('Estudante', 'tutor'); ?></span>
                    <span class="tutor-form-toggle-control"></span>
                    <span class="tutor-form-toggle-label tutor-form-toggle-<?php echo $view_as == 'instructor' ? 'checked' : 'unchecked'; ?>"><?php _e('Formador', 'tutor'); ?></span>
                </label>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="tutor-row">
            <div class="tutor-col-lg-5">
                <div class="tutor-qna-filter tutor-d-flex tutor-align-center">
                    <span class="tutor-fs-7 tutor-color-secondary tutor-mr-20"><?php _e('Ordenar por', 'tutor'); ?>:</span>
