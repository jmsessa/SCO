...
<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'Atribuição', 'tutor' ); ?></div>
	...
	<div class="tutor-row tutor-mb-24">
		<div class="tutor-col-lg-6 tutor-mb-16 tutor-mb-lg-0">
			<label class="tutor-form-label">
				<?php esc_html_e( 'Cursos', 'tutor' ); ?>
			</label>
			<select class="tutor-form-select tutor-announcement-course-sorting">
				<option value=""><?php esc_html_e( 'tudo', 'tutor' ); ?></option>
				<?php if ( $courses ) : ?>
					...
					<?php endforeach; ?>
				<?php else : ?>
					<option value=""><?php esc_html_e( 'Nenhum curso encontrado', 'tutor' ); ?></option>
				<?php endif; ?>
			</select>
		</div>

		<div class="tutor-col-6 tutor-col-lg-3">
			<label class="tutor-form-label"><?php esc_html_e( 'Ordenar por', 'tutor' ); ?></label>
		...
		<div class="tutor-col-6 tutor-col-lg-3">
			<label class="tutor-form-label"><?php esc_html_e( 'Data de criação', 'tutor' ); ?></label>
		...
		<div class="tutor-table-responsive">
			<table class="tutor-table table-assignment">
				<thead>
					<tr>
						<th>
							<?php esc_html_e( 'Nome da tarefa', 'tutor' ); ?>
						</th>
						<th>
							<span class="tutor-fs-7"><?php esc_html_e( 'Total de marcas', 'tutor' ); ?></span>
						</th>
						<th>
							<span class="tutor-fs-7"><?php esc_html_e( 'Envio total', 'tutor' ); ?></span>
						</th>
						<th></th>
					</tr>
				</thead>
						...
						<tr>
							<td>
								...
								<div class="tutor-fs-7 tutor-mt-8">
									<span class="tutor-fw-medium"><?php esc_html_e( 'Curso', 'tutor' ); ?>: </span>
