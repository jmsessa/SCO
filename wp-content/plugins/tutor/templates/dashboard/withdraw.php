...
$status_message = array(
	'rejected' => __( 'Entre em contato com o administrador do site para mais informações.', 'tutor' ),
	'pending'  => __( 'A solicitação de retirada está pendente para aprovação, por favor, aguarde.', 'tutor' ),
);
...
<div class="tutor-dashboard-content-inner tutor-frontend-dashboard-withdrawal tutor-color-black">
	<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"><?php echo __( 'Levantamento', 'tutor' ); ?></div>
	...
	<div class="tutor-card tutor-p-24">
		<div class="tutor-row tutor-align-lg-center">
			...
			<div class="tutor-col tutor-mb-16 tutor-mb-lg-0">
				<div class="tutor-fs-6 tutor-color-muted tutor-mb-4"><?php echo sprintf( 'Saldo atual é %s', $current_balance_formated ); ?></div>
				<div class="tutor-fs-5 tutor-color-black">
					<?php
					if ( $is_balance_sufficient ) {
						echo sprintf( __( 'Tu tens %1$s %2$s %3$s pronto para retirar agora', 'tutor' ), "<strong class='available_balance'>", $available_for_withdraw_formatted, '</strong>' );
					} else {
						echo sprintf( __( 'Você tem %1$s %2$s %3$s e este é saldo insuficiente para sacar', 'tutor' ), "<strong class='available_balance'>", $available_for_withdraw_formatted, '</strong>' );
					}
					?>
				</div>
			</div>
			...
			if ( $is_balance_sufficient && $withdraw_method_name ) {
				...
				<div class="tutor-col-lg-auto">
					<button class="tutor-btn tutor-btn-primary" data-tutor-modal-target="tutor-earning-withdraw-modal">
						<?php esc_html_e( 'Pedido de retiradat', 'tutor' ); ?>
					</button>
				</div>
					<?php
			}
	...
	<div class="current-withdraw-account-wrap tutor-d-flex tutor-mt-20">
		...
		<span class="tutor-fs-7 tutor-mt-4">
			...
			echo $withdraw_method_name ? sprintf( __( 'O método de pagamento preferido é selecionado como %s. ', 'tutor' ), $withdraw_method_name ) : '';
			echo sprintf( __( 'Você pode mudar sua %1$s Preferência de Retirada %2$s', 'tutor' ), "<a href='{$my_profile_url}'>", '</a>' );
			?>
		</span>
	</div>
				...
				<div class="tutor-modal-content tutor-modal-content-white">
					...
					<div class="tutor-modal-body">
						<div class="tutor-py-20 tutor-px-24">
							...
							<div class="tutor-fs-4 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'Pedido de retirada', 'tutor' ); ?></div>
							<div class="tutor-fs-6 tutor-color-muted"><?php esc_html_e( 'Verifique sua notificação de transação em seu método de saque conectado', 'tutor' ); ?></div>

							<div class="tutor-row tutor-mt-32">
								<div class="tutor-col">
									<div class="tutor-fs-6 tutor-color-secondary tutor-mb-4"><?php esc_html_e( 'Saldo Retirável', 'tutor' ); ?></div>
									<div class="tutor-fs-6 tutor-fw-bold tutor-color-black"><?php echo wp_kses_post( $available_for_withdraw_formatted ); ?></div>
								</div>

								<div class="tutor-col">
									<div class="tutor-fs-6 tutor-color-secondary tutor-mb-4"><?php esc_html_e( 'Método de pagamento selecionado', 'tutor' ); ?></div>
						...
						<form id="tutor-earning-withdraw-form" method="post">
							<div class="tutor-py-20 tutor-px-24">
								<div>
									...
									<label class="tutor-form-label" for="tutor_withdraw_amount"><?php esc_html_e( 'Quantia', 'tutor' ); ?></label>
									...
									<div class="tutor-form-help tutor-d-flex tutor-align-center">
										...
										<span><?php echo __( 'O valor mínimo de retirada é', 'tutor' ) . ' ' . strip_tags( $formatted_min_withdraw_amount ); ?></span>
									</div>
								...
								<div class="tutor-d-flex tutor-mt-48">
									...
									<div class="tutor-ml-auto">
										<button type="submit" name="withdraw-form-submit" id="tutor-earning-withdraw-btn" class="tutor-btn tutor-btn-primary tutor-modal-btn-edit tutor-ml-16">
											<?php esc_html_e( 'Enviar pedido', 'tutor' ); ?>
										</button>
									</div>
								</div>
							</form>
		...
		<div class="withdraw-history-table-wrap tutor-tooltip-inside tutor-mt-40">
			<div class="withdraw-history-table-title">
				<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"> 
					<?php esc_html_e( 'Histórico de retirada', 'tutor' ); ?>
				</div>
			</div>
			...
			<div class="tutor-table-responsive">
				<table class="tutor-table">
					<thead>
						<tr>
							<th width="40%">
								<?php esc_html_e( 'Método de Retirada', 'tutor' ); ?>
							</th>
							<th width="28%">
								<?php esc_html_e( 'Solicitado em', 'tutor' ); ?>
							</th>
							<th width="13%">
								<?php esc_html_e( 'Quantia', 'tutor' ); ?>
							</th>
							<th width="13%">
