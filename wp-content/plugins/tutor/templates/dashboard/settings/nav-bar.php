<?php
	...
	$setting_menus = array(
		'profile'        => array(
			...
			'title' => __( 'Perfil', 'tutor' ),
			'role'  => false,
		),
		'reset_password' => array(
			'url'   => esc_url( $reset_password ),
			'title' => __( 'Palavra-passe', 'tutor' ),
			'role'  => false,
		),
		'withdrawal'     => array(
			'url'   => esc_url( $withdraw ),
			'title' => __( 'levantamento', 'tutor' ),
			'role'  => 'instructor',
		),
		'social-profile' => array(
			'url'   => esc_url( $social ),
			'title' => __( 'Rede Social', 'tutor' ),
			'role'  => false,
		),
	);
...
<ul class="tutor-nav" tutor-priority-nav>
	...
	<li class="tutor-nav-item tutor-nav-more tutor-d-none">
		<a class="tutor-nav-link tutor-nav-more-item" href="#"><span class="tutor-mr-4"><?php _e("Mais", "tutor"); ?></span> <span class="tutor-nav-more-icon tutor-icon-times"></span></a>
