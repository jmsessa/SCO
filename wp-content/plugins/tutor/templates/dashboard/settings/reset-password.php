	...
	<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="tutor-row">
            <div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
                <label class="tutor-form-label tutor-color-secondary"> <?php esc_html_e('Palavra-passe atual', 'tutor'); ?> </label>
                <input class="tutor-form-control" type="password" name="previous_password" placeholder="Palavra-passe atual">
            </div>
        </div>
				...
				<div class="tutor-password-strength-checker">
					<div class="tutor-password-field">
						<label class="field-label tutor-form-label" for="tutor-new-password">
							<?php esc_html_e( 'Nova palavra-passe', 'tutor' ); ?>
						</label>
			...
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
				<div class="tutor-password-field tutor-settings-pass-field">
					<label class="field-label tutor-form-label" for="tutor-confirm-password">
						<?php esc_html_e( 'Confirmar palavra-passe', 'tutor' ); ?>
					</label>
		...
		<div class="tutor-row">
			<div class="tutor-col-12">
				<button type="submit" class="tutor-btn tutor-btn-primary tutor-profile-password-reset">
					<?php esc_html_e( 'Redefinir a palavra-passe', 'tutor' ); ?>
				</button>
			</div>
		</div>
	</form>
