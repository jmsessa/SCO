    ...
    <div class="tutor-modal-content tutor-announcement-modal-content">
        <div class="modal-header">
            <div class="modal-title">
                <h1><?php esc_html_e( 'Anúncio de atualização  ', 'tutor' ); ?></h1>
            </div>
        ...
        <div class="modal-container">
            <form action="" class="tutor-announcements-update-form">
                ...
                <div class="tutor-form-group">
                    <label>
                        <?php esc_html_e( 'Selecione Cursos', 'tutor' ); ?>
                    </label>
                ...
                <div class="tutor-form-group">
                    ...
                    <input type="text" name="tutor_announcement_title" id="tutor-announcement-title" value="" placeholder="<?php esc_attr_e( 'Título do anúncio', 'tutor' ); ?>" required>
                </div>
                <div class="tutor-form-group">
                    <label for="tutor_announcement_course">
                        <?php esc_html_e( 'Resumo', 'tutor' ); ?>
                    </label>
                    <textarea rows="6" type="text" id="tutor-announcement-summary" name="tutor_announcement_summary" value="" placeholder="<?php echo esc_attr__( 'Resumo...', 'tutor' ); ?>" required></textarea>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="tutor-btn"><?php esc_html_e( 'Atualizar', 'tutor' ) ?></button>
