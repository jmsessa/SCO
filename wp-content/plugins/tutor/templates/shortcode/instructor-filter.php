	...
	<div class="tutor-row">
		<aside class="tutor-col-lg-3 tutor-mb-32 tutor-mb-lg-0" tutor-instructors-filters>
			<div class="tutor-d-flex tutor-align-center">
				<div>
					...
					<span class="tutor-fs-5 tutor-fw-medium tutor-color-black"><?php _e("Filtros", "tutor"); ?></span>
				</div>
				...
				<div class="tutor-ml-32">
					<a href="#" class="tutor-btn tutor-btn-ghost" tutor-instructors-filter-clear>
						...
						<span class="tutor-fw-medium"><?php _e("Clara", "tutor"); ?></span>
					</a>
				</div>
			</div>
				...
				<div class="tutor-widget-content">
					...
					<?php if ( $show_more ) : ?>
						<a href="#" class="tutor-btn-show-more tutor-btn tutor-btn-ghost tutor-mt-32" data-tutor-toggle-more=".tutor-toggle-more-content">
							...
							<span class="tutor-toggle-btn-text"><?php esc_html_e( 'Mostre mais', 'tutor' ); ?></span>
						</a>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="tutor-widget tutor-widget-course-ratings tutor-mt-48">
				<h3 class="tutor-widget-title">
					<?php esc_html_e( 'avaliações', 'tutor' ); ?>
				</h3>
		...
		<main class="tutor-col-lg-9 tutor-col-xl-<?php echo $columns < 3 ? 8 : 9; ?>">
			<div class="tutor-form-wrap tutor-mb-24">
				...
				<input type="text" class="tutor-form-control" name="keyword" placeholder="<?php esc_html_e( 'Pesquise qualquer instrutor...', 'tutor' ); ?>" tutor-instructors-filter-search />
			</div>
