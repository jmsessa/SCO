...
$title  		= isset( $title ) ? $title : 'Você deseja excluir isso?';
		...
		<div class="tutor-modal-content tutor-modal-content-white">
			...
			<div class="tutor-modal-body tutor-text-center">
				<div class="tutor-my-32">
					<?php if ( $title ) : ?>
						<div class="tutor-fs-4 tutor-fw-medium tutor-color-black tutor-mb-8"><?php esc_html_e( $title ); ?></div>
					<?php endif; ?>
					<?php if ( $content ) : ?>
