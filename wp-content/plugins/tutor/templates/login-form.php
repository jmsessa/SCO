...
<form id="tutor-login-form" method="post">
	...
	<div class="tutor-mb-20">
		<input type="text" class="tutor-form-control" placeholder="<?php esc_html_e( 'Nome de Utilizador oo E-mail ', 'tutor' ); ?>" name="log" value="" size="20" />
	</div>

	<div class="tutor-mb-32">
		<input type="password" class="tutor-form-control" placeholder="<?php esc_html_e( 'Senha', 'tutor' ); ?>" name="pwd" value="" size="20" />
	</div>
