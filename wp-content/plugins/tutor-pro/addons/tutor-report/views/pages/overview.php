...
<div class="tutor-report-overview-wrap">
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Cursos Publicados', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Curso Inscrito', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Lições', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Questionário', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Questões', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Formadores', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Estudantes', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="tutor-card tutor-card-secondary tutor-p-24">
				<div class="tutor-d-flex">
					...
					<div class="tutor-ml-20">
						...
						<div class="tutor-fs-7 tutor-color-secondary"><?php _e( 'Avaliações', 'tutor-pro' ); ?></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="tutor-analytics-wrapper tutor-analytics-graph tutor-mt-12">
		...
		<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-d-flex tutor-align-center tutor-justify-between tutor-mb-16">
			<div>
				<?php esc_html_e( 'Gráfico de ganhos', 'tutor-pro' ); ?>
			</div>
		...
		<div class="tutor-overview-month-graph">
			...
			<?php
				...
				$graph_tabs     = array(
					array(
						'tab_title'     => __( 'Ganhos totais', 'tutor-pro' ),
						'tab_value'     => $earnings['total_earnings'],
						'data_attr'     => 'ta_total_earnings',
						'active'        => ' is-active',
						'price'         => true,
						'content_title' => __( 'Gráfico de Ganhos ' . $content_title, 'tutor-pro' ),
					),
					array(
						'tab_title'     => __( 'Curso Inscrito', 'tutor-pro' ),
						'tab_value'     => $enrollments['total_enrollments'],
						'data_attr'     => 'ta_total_course_enrolled',
						'active'        => '',
						'price'         => false,
						'content_title' => __( 'Gráfico de Inscrições no Curso ' . $content_title, 'tutor-pro' ),
					),
					array(
						'tab_title'     => __( 'Reembolso Total', 'tutor-pro' ),
						'tab_value'     => $refunds['total_refunds'],
						'data_attr'     => 'ta_total_refund',
						'active'        => '',
						'price'         => true,
						'content_title' => __( 'Gráfico de Reembolso ' . $content_title, 'tutor-pro' ),
					),
					array(
						'tab_title'     => __( 'Desconto Total', 'tutor-pro' ),
						'tab_value'     => $discounts['total_discounts'],
						'data_attr'     => 'ta_total_discount',
						'active'        => '',
						'price'         => true,
						'content_title' => __( 'Desconto Total ' . $content_title, 'tutor-pro' ),
					),
				);
	...
	<div class="tutor-mb-48" id="tutor-courses-overview-section">
				...
				<table class="tutor-table tutor-table-responsive table-popular-courses">
					<thead>
						<tr>
							...
							<th class="tutor-table-rows-sorting">
								<div class="tutor-d-inline-flex tutor-align-center tutor-color-secondary">
									<span class="tutor-fs-7">
										<?php esc_html_e( 'Avaliação', 'tutor-pro' ); ?>
									</span>
									<span class="tutor-icon-ordering-a-z a-to-z-sort-icon"></span>
								</div>
							</th>
					...
					<?php if ( is_array( $most_popular_courses ) && count( $most_popular_courses ) ) : ?>
						<?php foreach ( $most_popular_courses as $course ) : ?>
							<tr>
								<td data-th="<?php esc_html_e( 'Nome do Curso', 'tutor-pro' ); ?>" class="course-name column-fullwidth">
								...
								<td data-th="<?php esc_html_e( 'Total de inscritos', 'tutor-pro' ); ?>" class="total-enrolled">
									<span class="tutor-fs-7 tutor-fw-medium  tutor-color-black">
										<?php echo esc_html( $course->total_enrolled ); ?>
									</span>
								</td>
								<td data-th="<?php esc_html_e( 'Avaliação do Curso', 'tutor-pro' ); ?>" class="course-rating">
		...
		<div class="single-overview-section tutor-last-enrolled-courses">
			<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24">
				<?php esc_attr_e( 'Últimos cursos inscritos', 'tutor-pro' ); ?>
			</div>
			<div class="tutor-table-wrapper">
				<table class="tutor-table tutor-table-responsive table-popular-courses">
					<thead>
					...
					<?php if ( is_array( $last_enrolled_courses ) && count( $last_enrolled_courses ) ) : ?>
						<?php foreach ( $last_enrolled_courses as $course ) : ?>
							<tr>
								<td data-th="<?php esc_html_e( 'Nome do Curso', 'tutor-pro' ); ?>" class="column-fullwidth course-name">
									<div class="tutor-fs-6 tutor-fw-medium  tutor-color-black">
										<span>
											<?php echo esc_html( $course->post_title ); ?>
										</span>
								...
								<td data-th="<?php esc_html_e( 'Data', 'tutor-pro' ); ?>" class="date">
									<span class="tutor-fs-7 tutor-fw-medium  tutor-color-black">
								...
								<td data-th="<?php esc_html_e( 'Avaliação', 'tutor-pro' ); ?>" class="rating">
									<div class="td-tutor-rating tutor-fs-6 tutor-color-secondary">
										<?php tutor_utils()->star_rating_generator_v2( isset($course_rating->rating_avg)?$course_rating->rating_avg:0, null, true ); ?>
									</div>
								</td>
	...
	<div id="tutor-courses-review-section" class="tutor-mb-48">
		<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24">
			<?php esc_html_e( 'Avaliações Recentes', 'tutor-pro' ); ?>
		</div>
		<div class="tutor-table-wrapper">
					...
					<tr>
						<th class="tutor-table-rows-sorting">
							<div class=" tutor-align-center tutor-d-flex">
								<span class="tutor-fs-7 tutor-color-secondary">
									<?php esc_html_e( 'Estudante', 'tutor-pro' ); ?>
								</span>
								<span class="tutor-icon-ordering-a-z a-to-z-sort-icon"></span>
							</div>
						</th>
						...
						<th>
							<span class="tutor-fs-7 tutor-color-secondary">
								<?php esc_html_e( 'Curso', 'tutor-pro' ); ?>
							</span>
						</th>
						<th>
							<span class="tutor-fs-7 tutor-color-secondary">
								<?php esc_html_e( 'Opinião', 'tutor-pro' ); ?>
							</span>
						</th>
						<th>
							<span></span>
				...
				<tbody>
					<?php if ( is_array( $reviews ) && count( $reviews ) ) : ?>
						<?php foreach ( $reviews as $review ) : ?>
							<tr>
								<td data-th="<?php esc_html_e( 'Estudante', 'tutor-pro' ); ?>" class="student column-fullwidth">
									<div class="td-avatar">
								...
								<td data-th="<?php esc_html_e( 'Curso', 'tutor-pro' ); ?>" class="course">
									<span class="tutor-fs-7 tutor-fw-medium  tutor-color-black">
										<?php echo esc_html( get_the_title( $review->comment_post_ID ) ); ?>
									</span>
								</td>
								<td data-th="<?php esc_html_e( 'Opinião', 'tutor-pro' ); ?>" class="feedback">
								...
								<td data-th="<?php esc_html_e( 'Ação', 'tutor-pro' ); ?>" class="review-action-btns">
	...
	<div id="tutor-new-registered-section">
		<div class="single-new-registered-section">
			<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24">
				<?php esc_html_e( 'Novos alunos registrados', 'tutor-pro' ); ?>
			</div>
			<div class="tutor-table-wrapper">
					...
					<thead>
						<tr>
							...
							<th>
								<div class="tutor-d-inline-flex tutor-align-center tutor-color-secondary">
									<span class="tutor-fs-7">
										<?php esc_html_e( 'Registre-se em', 'tutor-pro' ); ?>
									</span>
								</div>
							</th>
						</tr>
					...
					<tbody>
						<?php if ( is_array( $students ) && count( $students ) ) : ?>
							<?php foreach ( $students as $student ) : ?>
								<tr>
									<td data-th="<?php esc_html_e( 'Estudante', 'tutor-pro' ); ?>">
									...
									<td data-th="<?php esc_html_e( 'Registado em:', 'tutor-pro' ); ?>">
										<div class="td-tutor-rating tutor-fs-6 tutor-color-secondary">
		...
		<div class="single-new-registered-section">
			<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24">
				<div class="heading">
					<?php esc_html_e( 'Novos Professores Registrados', 'tutor-pro' ); ?>
				</div>
			</div>
			<div class="tutor-table-wrapper">
				<table class="tutor-table tutor-table-responsive">
					<thead>
						<tr>
							<th class="tutor-table-rows-sorting">
								<div class="tutor-d-flex  tutor-align-center">
									<span class="tutor-fs-7 tutor-color-secondary">
										<?php esc_html_e( 'Professor', 'tutor-pro' ); ?>
									</span>
									<span class="tutor-icon-ordering-a-z a-to-z-sort-icon"></span>
								</div>
							</th>
					...
					<tbody>
						<?php if ( is_array( $teachers ) && count( $teachers ) ) : ?>
							<?php foreach ( $teachers as $teacher ) : ?>
								<tr>
									<td data-th="<?php esc_html_e( 'Professor', 'tutor-pro' ); ?>">
										<div class="tutor-instructor-card">
