		...
		<div class="notice notice-error tutor-install-notice" style="display:flex; tutor-justify: space-between; align-items: center;">
			<div class="tutor-install-notice-inner" style="display: flex; column-gap: 20px;">
				...
				<div class="tutor-install-notice-content">
					...
					<p>
						<?php
							$notice = __( 'It seems you have installed the wrong version Of Tutor LMS. For a smoother Tutor LMS experience, you need to install Tutor LMS ' . TUTOR_CORE_REQ_VERSION . ' (Free) version.', 'tutor-pro' );
							echo esc_html( $notice );
						?>
					</p>
					<p style="color: #757C8E;">
						<?php esc_html_e( 'Note: Tutor LMS pro will be installed but you will not be able to avail any of its’ features.', 'tutor-pro' ); ?>
					</p>
				</div>
			</div>
			<div class="tutor-install-notice-button">
				<a class="button button-primary" href="https://downloads.wordpress.org/plugin/tutor.<?php echo TUTOR_CORE_REQ_VERSION; ?>.zip" target="_blank">
					<?php esc_html_e( 'Download Now', 'tutor-pro' ); ?>
				</a>
			</div>
		</div>
		<?php
